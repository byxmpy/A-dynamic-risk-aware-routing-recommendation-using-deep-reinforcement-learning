...
import graph
import numpy as np
distance=np.load('100distance30.npy')
crime=np.load('100crime30.npy')
...
order_price_dist = []
mapped_matrix_int = np.array([[5, 8, 2, 17, 15, 26, 27, 25, 30, 28, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 400, 402, 404, 406, 408, 410, 412, 414, 416, 418], [1, 7, 3, 23, 19, 29, 31, 33, 35, 37, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 401, 403, 405, 407, 409, 411, 413, 415, 417, 419],[600, 601, 602, 603, 604, 605, 606, 607, 608, 609 ,610, 611, 612, 613, 614, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 625, 626, 627, 628, 629],
 [6, 4, 9, 11, 22, 32, 34, 36, 38, 39, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 420, 422, 424, 426, 428, 430, 432, 434, 436, 438], [130, 140, 131, 141, 132, 142, 133, 143, 134, 144, 135, 145, 136, 146, 137, 147, 138, 148, 139, 149, 421, 423, 425, 427, 429, 431, 433, 435, 437, 439],[660, 661, 662, 663, 664, 665, 666, 667, 668, 669, 670, 671, 672, 673, 674, 675, 676, 677, 678, 679, 680, 681, 682, 683, 684, 685, 686, 687, 688, 689],
 [16, 10, 13, -100, 21, 40, 42, 44, 46, 48, 150, 152, 151, 154, 153, 156, 157, 158, 159, 155, 440, 442, 444, 446, 448 ,450, 452, 454, 456, 458], [12, 14, 18, 20, 24, 41, 43, 45, 47, 49, 160, 162, 164, 161, 163, 166, 165, 168, 167, 169, 441, 443, 445, 447, 449 ,451, 453, 455, 457, 459],[630, 631, 632, 633, 634, 635, 636, 637, 638, 639, 650, 651, 652, 653, 654, 655, 656, 657, 658, 659, 640, 641, 642, 643, 644, 645, 646, 647, 648, 649],
  [50, 52, 54, 56, 58, 60, 62, 64, 66, 68, 171, 170, 174, 173, 178, 175, 176, 177, 179, 172, 460, 462, 464, 466, 468 ,470, 472, 474 ,476, 478], [181, 191, 180, 190, 182, 192, 183, 193, 184, 194, 185, 195, 187, 197, 186, 196, 189, 199, 188, 198, 461, 463, 465, 467, 469, 471, 473, 475, 477, 479],[690, 691, 692, 693, 694, 695, 696, 697, 698, 699, 700, 701, 702, 703, 704, 705, 706, 707, 708, 709, 710, 711, 712, 713, 714, 715, 716, 717, 718, 719],
  [51, 53, 55, 57, 59, 61, 63, 65, 67, 69, 200, 201, 209, 203, 202, 204, 205, 206, 207, 208, 480, 482, 484, 486, 488, 490, 492, 494, 496, 498], [70, 72, 74, 76, 78, 80, 82, 84, 86, 88, 210, 211, 212, 213, 219, 218, 217, 215, 214, 216, 481, 483, 485, 487, 489, 491, 493, 495, 497, 499],[720, 721, 722, 723, 724, 725, 726, 727, 728, 729, 730, 731, 732, 733, 734, 735, 736, 737, 738, 739, 740 ,741, 742, 743, 744, 745, 746, 747, 748, 749],
  [71, 73, 75, 77, 79, 81, 83, 85, 87, 89, 220, 221, 224, 223, 226, 225, 227, 229, 228, 222, 500, 502, 504, 506, 508 ,510, 512, 514, 516, 518], [90, 92, 94, 96, 98, 91, 93, 95, 97, 99, 231, 239, 230, 238, 232, 233, 234, 236, 235, 237, 501, 503, 505, 507, 509, 511, 513, 515, 517, 519],[780, 781, 782, 783, 784, 785, 786, 787, 788, 789, 790, 791, 792, 793, 794, 795, 796, 797, 798, 799, 800, 801, 802, 803, 804, 805, 806, 807, 808, 809],
  [240, 250, 242, 252, 241, 251, 244, 254, 253, 243, 245, 256, 246, 247, 257, 248, 258, 249, 259, 255, 520, 522, 524, 526, 528 ,530, 532, 534, 536, 538], [260, 270, 261, 271, 262, 272, 263, 273, 264, 274, 265, 275, 266, 276, 268, 279, 278, 269, 277, 267, 521, 523, 525, 527, 529, 531, 533, 535, 537, 539],[750, 751, 752, 753, 754, 755, 756, 757, 758, 759, 760, 761, 762, 763, 764, 765, 766, 767, 768, 769, 770, 771, 772, 773, 774, 775, 776, 777, 778, 779],
  [280, 290, 281, 291, 282, 292, 283, 293, 284, 294, 285, 295, 286, 296, 287, 297, 298, 288, 299, 289, 540, 542, 544, 546, 548, 550, 552, 554, 556, 558], [300, 302, 310, 312, 311, 301, 303, 313, 304, 314, 305, 315, 307, 317, 306, 316, 318, 309, 319, 308, 541, 543, 545, 547, 549, 551, 553, 555, 557, 559],[810, 811, 812, 813, 814, 815, 816, 817, 818, 819, 820, 821, 822, 823, 824, 825, 826, 827, 828, 829, 830, 831, 832, 833, 834, 835, 836, 837, 838, 839],
  [320, 321, 330, 331, 323, 333, 322, 332, 329, 339, 328, 338, 334, 324, 336, 326, 325, 335, 337, 327, 560, 562, 564, 566, 568, 570, 572, 574, 576, 578], [340, 342, 345, 350, 352, 355, 353, 343, 341, 351, 346, 356, 344, 354, 357, 347, 348, 358, 349, 359, 561, 563, 565, 567, 569, 571, 573, 575, 577, 579],[840, 841, 842, 843, 844, 845, 846, 847, 848, 849, 850 ,851, 852, 853, 854, 855, 856, 857, 858, 859, 860, 861 ,862, 863, 864, 865, 866, 867, 868, 869],
  [360, 370, 362, 372, 361, 371, 365, 375, 364, 374, 369, 379, 366, 373, 363, 376, 367, 377, 368, 378, 580, 582, 584, 586, 588, 590, 592, 594, 596, 598], [380, 390, 382, 392, 387, 397, 388, 398, 381, 391, 383, 393, 384, 394, 385, 395, 396, 386, 389, 399, 581, 583, 585, 587, 589, 591, 593, 595, 597, 599],[870, 871, 872, 873, 874, 875, 876, 877, 878, 879, 880, 881, 882, 883, 884, 885, 886, 887, 888, 889, 890, 891, 892, 893, 894, 895, 896, 897, 898, 899]
  ])

M, N = mapped_matrix_int.shape
order_num_dist = []
num_valid_grid = 899
idle_driver_location_mat = np.zeros((144, 899))
    ...
    for i in range(1, 900):
        ...
        for j in range(1, 900):
            ...
            if flag < 100:
                if distance[i][j] != 0:
                    asd = find_du(i,j,30)
                    a.append([daoda, j, tt, 10, 10000+asd*300])
        order_real += a
...
for n_iter in np.arange(360):
    origin_distance=np.load('100distance30.npy')
    distance = origin_distance
    origin_crime=np.load('100crime30.npy')
    crime = origin_crime
            ...
            if rl_end == 0:
                if ii >= 30:
                    ...
                    if start != start_node and number_max > 0 and flag != 3:#判断有路线而且过了出发点判定  
                        ...
                        flag = 3#结束了
                        if next_node == daoda:
                            reward_cost[end] += daoda_parameter1 + daoda_parameter2*find_du(chufa,daoda,30)
                            rl_end = 1
                            rl_end_time = tttt()
...
data.to_excel('100risk_30_1_data1.00_0.04_1.xls')
