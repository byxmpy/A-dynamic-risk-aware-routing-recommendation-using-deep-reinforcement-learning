...
import graph
import numpy as np
distance=np.load('70distance30.npy')
crime=np.load('70crime30.npy')
...
for n_iter in np.arange(180):
    origin_distance=np.load('70distance30.npy')
    distance = origin_distance
    origin_crime=np.load('70crime30.npy')
    crime = origin_crime
...
data.to_excel('70risk_30_1_data1.00_0.10_1.xls')
