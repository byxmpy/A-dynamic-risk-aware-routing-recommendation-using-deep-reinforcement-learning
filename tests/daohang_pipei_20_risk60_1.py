...
import graph
import numpy as np
distance=np.load('60distance20.npy')
crime=np.load('60crime20.npy')
...
for n_iter in np.arange(180):
    origin_distance=np.load('60distance20.npy')
    distance = origin_distance
    origin_crime=np.load('60crime20.npy')
    crime = origin_crime
...
data.to_excel('60risk_20_1_data1.00_0.10_19.xls')
