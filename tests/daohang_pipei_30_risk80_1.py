...
import graph
import numpy as np
distance=np.load('80distance30.npy')
crime=np.load('80crime30.npy')
...
for n_iter in np.arange(180):
    origin_distance=np.load('80distance30.npy')
    distance = origin_distance
    origin_crime=np.load('80crime30.npy')
    crime = origin_crime
...
data.to_excel('80risk_30_1_data1.00_0.02_5.xls')
